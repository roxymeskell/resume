...
\begin{document}
	...
	%\vspace{-.75\baselineskip}%
		...
		Worked as part of the SaaS Protection Team, working on a subset of a distributed system that manages discovering Miscrosoft Office 365 and Google Workspace seats when they are created, updated, or deleted from the SaaS providers. %

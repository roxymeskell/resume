...
%	\end{tabular}
	...
	%\vspace{-.75\baselineskip}%
		...
		\fwork{Bryx}[Rochester, NY][October 2019 - Present][Software Engineer][%
		Design, develop, and test new user interfaces for the Bryx911 web applications.%
		Provide customer support to both Bryx911 and Bryx Staion users.%
		]%
